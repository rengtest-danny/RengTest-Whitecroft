...
public class DBResultSet implements ResultSet
{
    ...
    {
        this.rs = rs;
//        try { this.rs.getStatement().closeOnCompletion(); }
//        catch ( Exception e ) { e.printStackTrace(); }
    ...
    //main purpose : also close statement object
    ...
    public JsonArray getJson ()
    {
        ...
        try
        {
            ...
            { // convert each object to an human readable JSON object
                ...
                {
                    row.addProperty( rsMeta.getColumnName( i ), rs.getString( rsMeta.getColumnName( i ) ) );
                }
                result.add( row );
            }
        }
